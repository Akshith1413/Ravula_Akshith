  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-4 text-center pb-12 pt-16">
        ...
        <motion.div 
          className="text-xl md:text-3xl font-light text-cyan-50/70 mb-4 mt-8"
        ...
        <h1 
          ref={titleRef}
          className="text-6xl md:text-7xl font-black bg-clip-text text-transparent bg-gradient-to-r from-white via-violet-200 to-indigo-400 mb-4 pt-2 pb-4 pr-2 drop-shadow-[0_10px_20px_rgba(0,0,0,0.3)]"
          style={{
        ...
        <div className="h-24 md:h-32 overflow-hidden relative mb-6 flex items-center justify-center w-full z-10">
          <AnimatePresence mode="wait">
            <motion.div
              key={currentWord}
              className="text-3xl md:text-5xl font-black bg-clip-text text-transparent bg-gradient-to-r from-cyan-300 via-fuchsia-400 to-pink-400 py-2 leading-normal selection:bg-purple-500/30 relative z-20"
        ...
        <motion.p
          ref={subtitleRef}
          className="text-xl md:text-2xl text-purple-100/80 max-w-2xl mx-auto mb-8 font-medium italic"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
